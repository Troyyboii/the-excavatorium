...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", href: "/lantern-favicon.ico", type: "image/x-icon" },
      { rel: "manifest", href: "/lantern.webmanifest" },
      {
        rel: "apple-touch-icon",
        href: "/lantern-apple-touch-icon.png",
        sizes: "180x180",
      },
      { rel: "icon", href: "/lantern-icon-192.png", type: "image/png", sizes: "192x192" },
      { rel: "icon", href: "/lantern-icon-512.png", type: "image/png", sizes: "512x512" },
    ],
  }),
